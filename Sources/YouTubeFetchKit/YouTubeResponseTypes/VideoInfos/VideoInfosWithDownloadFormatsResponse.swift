...
public struct VideoInfosWithDownloadFormatsResponse: YouTubeResponse {
    ...
    public typealias VideoDownloadFormat = YouTubeFetchKit.VideoDownloadFormat
    ...
    public typealias AudioOnlyFormat = YouTubeFetchKit.AudioOnlyFormat
    ...
    static func decodeFormatFromJSON(json: JSON) -> DownloadFormat {
        if json["fps"].int != nil {
            ...
            return YouTubeFetchKit.VideoDownloadFormat(
            ...
            return YouTubeFetchKit.AudioOnlyFormat(
                averageBitrate: json["averageBitrate"].int,
                contentLength: {
                    if let contentLength = json["contentLength"].string {
                        return Int(contentLength)
